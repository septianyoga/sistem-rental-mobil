...
<head>
    ...
    <base href="<?php echo base_url('templet/template') ?>/">
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        ...
                        <h3 class="welcome-sub-text">Dashboard Website Rental Mobil </h3>
                    </li>
                </ul>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item nav-category">Master Mobil</li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                            <i class="menu-icon mdi mdi-floor-plan"></i>
                            <span class="menu-title">Data Merk</span>
                    ...
                    <li class="nav-item nav-category">Master Pemesanan</li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="collapse" href="#charts" aria-expanded="false" aria-controls="charts">
                            ...
                            <span class="menu-title">Data Jenis Bayar</span>
                            <i class="menu-arrow"></i>
                        </a>
                    ...
                    <li class="nav-item nav-category">Master Pesanan</li>
                    <li class="nav-item">
