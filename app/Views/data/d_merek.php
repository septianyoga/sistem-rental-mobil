                            ...
                            <tbody>
                                ...
                                <?php foreach ($data_merk as $m) : ?>
                                    <tr>
                                        ...
                                        <td><?= $m->merk; ?></td>
                                        <td>
                                            <a href="ubahmerk/ubah/<?= $m->id_merk; ?>" class="btn btn-sm btn-info"><i class="fa fa-pen"></i> Ubah</a>
                                            <a href="dashboard/hapus/<?= $m->id_merk; ?>" class="btn btn-sm btn-danger" onclick="return confirm('apakah anda yakin?')"><i class="fa fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
                                    <?php $i++; ?>
                                <?php endforeach; ?>
